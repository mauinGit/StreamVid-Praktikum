...
{{-- Cover Upload --}}
<div class="sv-form-group">
    <label class="sv-label">Cover (Hero Background)</label>
...
<div class="sv-form-group">
    ...
    <p style="font-size:0.75rem;color:var(--sv-text-muted);margin-bottom:8px;">Upload file video langsung ke server. Format: MP4, WebM, OGG. Maks 100MB.</p>
    ...
    @endif
    <input type="file" name="video_file" class="sv-input" accept="video/mp4,video/webm,video/ogg" style="padding:10px;" {{ !isset($film) ? 'required' : '' }}>
</div>
